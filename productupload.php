...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$productupload="INSERT INTO allproducts (prod_name,prod_category,prod_description,prod_brand,prod_price,prod_image) 
							VALUES ('$prod_name','$prod_category','$prod_description','$prod_brand','$prod_price','$prod_imagename')"; 
